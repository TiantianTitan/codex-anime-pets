...
本リポジトリには、非公式のファンメイド・キャラクターアニメーションが含まれています。一部のビジュアル素材は Codex またはその他の AI ツールで生成されており、原作に基づく二次創作に該当する場合があります。「非営利目的」「学習・交流目的のみ」「権利はそれぞれの権利者に帰属します」「AI 生成」「ファンワーク」「権利侵害がある場合はご連絡ください」などの表示は、本プロジェクトの立場を示すのみです。これらは権利者からの許諾を与えるものでは**なく**、第三者の権利の移転、著作権上の例外の成立、権利主張や削除要請の防止、その他の著作権問題の解決を意味しません。

本リポジトリのオープンソースライセンスは、各貢献者がライセンスを付与する権利を有するオリジナルのコードおよび素材にのみ適用されます。第三者のキャラクター名、キャラクターデザイン、アートワーク、商標、原素材はこのライセンスの対象外です。第三者の著作物に関する権利は、それぞれの権利者に留保されます。キャラクター素材を再配布、公開または商用利用する前に、許諾が必要かどうかを確認し、必要な場合は許諾を得る責任は利用者にあります。
