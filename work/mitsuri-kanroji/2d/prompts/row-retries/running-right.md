Create Codex pet row `running-right` for `mitsuri-kanroji`: exactly 8 full-body frames in one horizontal strip on flat pure cyan #00FFFF.

Use the attached canonical base for identity and the layout guide only for spacing. Same pet in every frame: Mitsuri Kanroji as a compact full-body 2D chibi anime sticker pet: pink hair fading to lime green in two thick braids, large green eyes, dark Demon Slayer uniform, white haori, striped green socks and sandals, warm energetic personality; keep hands and braids attached close to the body; no sword, hearts, text, scenery, shadows, glow, or detached effects. Preserve silhouette, face, palette, material, proportions, markings, and props.
